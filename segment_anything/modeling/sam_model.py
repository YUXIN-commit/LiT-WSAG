...
#from .unet_8 import UNet
from .sea_unet import SEA_Unet_5
class Sam(nn.Module):
    ...
    def __init__(
        ...
        assert unet != None,'传入unet函数为空'
        self.unet = unet
        
        #self.unet = SEA_Unet_5
    ...
    def forward(self, batched_input: Dict[str, Any], multimask_output: bool) -> List[Dict[str, torch.Tensor]]:
        ...
        print('22222222222222222222222222222222222222222222221111111111111111111111111111111111111')
        final_masks=self.unet(masks)
        outputs = {
                    "masks": final_masks,
