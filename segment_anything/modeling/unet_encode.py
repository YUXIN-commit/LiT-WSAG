...
class UNet_encode(nn.Module):
    def __init__(self):
        ...
        self.enc_conv4 = nn.Sequential(nn.Conv2d(256, 256, kernel_size=3, stride=2, padding=1), nn.ReLU(), nn.Conv2d(512, 512, kernel_size=3, padding=1), nn.ReLU())
