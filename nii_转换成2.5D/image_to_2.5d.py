...
# 路径变量
image_path = r"D:\workSpace\data\Task03_Liver\Task03_Liver\imagesTs"
#label_path = r"D:\workSpace\data\Task03_Liver\train_2d\mask_nii"
output_image_dir = r"D:\workSpace\data\Task03_Liver\test\images_2.5d"
# output_label_dir = r"D:\workSpace\data\Task03_Liver\train_2.5d\masks_2.5d" # No longer needed
# 窗宽和窗位
window_width = 1601
window_center = -300
...
def convert_3d_to_2_5d(image_path, output_image_dir):
    # 确保输出目录存在
...
# 使用函数
convert_3d_to_2_5d(image_path, output_image_dir)
